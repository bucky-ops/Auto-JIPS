...
SKILL_DATABASE = {
    ...
    "web_frameworks": {
        ...
        "jquery", "bootstrap", "tailwind", "material-ui", "redux"
    },
    ...
    "databases": {
        ...
        "sqlite", "neo4j", "couchdb", "influxdb", "timescaledb"
    },
    ...
    "devops": {
        ...
        "vagrant", "puppet", "chef", "nginx", "apache", "prometheus",
        "grafana", "datadog", "new relic", "splunk"
    },
    
    # Data & Analytics
    "data_tools": {
        "spark", "apache spark", "hadoop", "airflow", "kafka", "flink",
    ...
    "methodologies": {
        ...
        "microservices", "rest", "restful", "graphql", "api", "soap",
        "oauth", "jwt", "saml", "sso"
    },
    ...
    "soft_skills": {
        ...
        "presentation", "documentation", "project management"
    }
}
...
MULTI_WORD_SKILLS = {
    ...
    "back end", "backend", "frontend", "cloud computing", "big data",
    "artificial intelligence", "version control", "continuous integration",
    "continuous deployment", "test driven development", "object oriented",
    "functional programming", "responsive design", "user experience",
    "user interface", "ui/ux", "rest api", "microservices architecture"
}
...
def extract_education_requirements(text: str) -> List[str]:
    ...
    if re.search(r'\b(certification|certified|certificate)\b', text_lower):
